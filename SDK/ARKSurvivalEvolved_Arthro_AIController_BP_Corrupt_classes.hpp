...
#include "ARKSurvivalEvolved_Arthro_AIController_BP_Corrupt_structs.hpp"
...
// BlueprintGeneratedClass Arthro_AIController_BP_Corrupt.Arthro_AIController_BP_Corrupt_C
// 0x0027 (0x0910 - 0x08E9)
class AArthro_AIController_BP_Corrupt_C : public AArthro_AIController_BP_C
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Arthro_AIController_BP_Corrupt.Arthro_AIController_BP_Corrupt_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_Arthro_AIController_BP_Corrupt(int EntryPoint);
};
