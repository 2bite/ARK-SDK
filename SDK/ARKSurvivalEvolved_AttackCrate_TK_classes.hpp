...
#include "ARKSurvivalEvolved_AttackCrate_TK_structs.hpp"
...
// BlueprintGeneratedClass AttackCrate_TK.AttackCrate_TK_C
// 0x002C (0x00A4 - 0x0078)
class UAttackCrate_TK_C : public UBTTask_BlueprintBase
{
public:
	...
	bool                                               CallFunc_DoAttack_ReturnValue;                            // 0x00A1(0x0001) (ZeroConstructor, Transient, DuplicateTransient, IsPlainOldData)
	bool                                               CallFunc_IsAttacking_ReturnValue;                         // 0x00A2(0x0001) (ZeroConstructor, Transient, DuplicateTransient, IsPlainOldData)
	bool                                               CallFunc_Not_PreBool_ReturnValue;                         // 0x00A3(0x0001) (ZeroConstructor, Transient, DuplicateTransient, IsPlainOldData)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass AttackCrate_TK.AttackCrate_TK_C");
		return ptr;
	}


	void ReceiveExecute(class AActor** OwnerActor);
	void ExecuteUbergraph_AttackCrate_TK(int EntryPoint);
};
