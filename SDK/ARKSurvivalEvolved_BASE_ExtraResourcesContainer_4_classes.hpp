...
#include "ARKSurvivalEvolved_BASE_ExtraResourcesContainer_4_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BASE_ExtraResourcesContainer_4.BASE_ExtraResourcesContainer_3_C");
		return ptr;
	}


	void ExecuteUbergraph_BASE_ExtraResourcesContainer_4(int EntryPoint);
};
