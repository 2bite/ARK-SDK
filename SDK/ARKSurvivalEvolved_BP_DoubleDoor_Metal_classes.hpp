...
#include "ARKSurvivalEvolved_BP_DoubleDoor_Metal_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_DoubleDoor_Metal.BP_DoubleDoor_Metal_C");
		return ptr;
	}


	void UserConstructionScript();
	void ExecuteUbergraph_BP_DoubleDoor_Metal(int EntryPoint);
};
