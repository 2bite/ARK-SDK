...
{
public:
	class UStaticMeshComponent*                        RightPillar;                                              // 0x0AD0(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UStaticMeshComponent*                        LeftPillar;                                               // 0x0AD8(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
