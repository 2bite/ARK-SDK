...
// (NetRequest, Exec, Static, MulticastDelegate, Public, Private, Protected, NetServer, HasOutParms, NetClient, BlueprintEvent, NetValidate)

void ABP_EX_Sky_Sphere_ARK_C::STATIC_UserConstructionScript()
{
