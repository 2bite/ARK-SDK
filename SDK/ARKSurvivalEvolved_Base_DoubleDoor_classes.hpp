...
{
public:
	class UBoxComponent*                               OutsideBox;                                               // 0x0B68(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UBoxComponent*                               InsideBox;                                                // 0x0B70(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UBoxComponent*                               PlayerCheckBox;                                           // 0x0B78(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
