...
{
public:
	class UParticleSystemComponent*                    BeerParticles;                                            // 0x0ED0(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UPrimalInventoryBP_BeerBarrel_C*             PrimalInventoryBP_BeerBarrel_C1;                          // 0x0ED8(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
