...
{
public:
	class UParticleSystemComponent*                    BeerParticles;                                            // 0x0EF0(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UPrimalInventoryBP_BeerBarrel_C*             PrimalInventoryBP_BeerBarrel_C1;                          // 0x0EF8(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
