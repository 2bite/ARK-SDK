...
#include "ARKSurvivalEvolved_BeginFly_TK_Archa_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BeginFly_TK_Archa.BeginFly_TK_Archa_C");
		return ptr;
	}


	void ReceiveExecute(class AActor** OwnerActor);
	void ExecuteUbergraph_BeginFly_TK_Archa(int EntryPoint);
};
