...
public:
	...
	class UStaticMesh*                                 WrappedMesh;                                              // 0x0970(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	...
	unsigned char                                      UnknownData05[0x8];                                       // 0x09C8(0x0008) MISSED OFFSET
