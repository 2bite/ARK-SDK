...
public:
	...
	class UStaticMesh*                                 chargeEffectMeshOverride;                                 // 0x0BB0(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
