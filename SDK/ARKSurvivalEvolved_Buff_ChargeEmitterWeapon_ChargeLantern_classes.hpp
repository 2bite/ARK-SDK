...
public:
	...
	class UStaticMesh*                                 chargeEffectMeshOverride;                                 // 0x0BC8(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
