...
// 0x0034 (0x0BC4 - 0x0B90)
class ABuff_ChargeEmitterWeapon_C : public ABuff_ChargeEmitter_C
{
public:
	struct FVector                                     K2Node_CustomEvent_NewParam;                              // 0x0B90(0x000C) (ZeroConstructor, Transient, DuplicateTransient, IsPlainOldData)
	struct FLinearColor                                K2Node_CustomEvent_NewParam1;                             // 0x0B9C(0x0010) (ZeroConstructor, Transient, DuplicateTransient, IsPlainOldData)
	struct FVector                                     K2Node_CustomEvent_NewParam2;                             // 0x0BAC(0x000C) (ZeroConstructor, Transient, DuplicateTransient, IsPlainOldData)
	struct FVector                                     K2Node_CustomEvent_NewParam12;                            // 0x0BB8(0x000C) (ZeroConstructor, Transient, DuplicateTransient, IsPlainOldData)
