...
// 0x0011 (0x0AC9 - 0x0AB8)
class ABuff_ChargeEmitter_LanternPet_C : public ABuff_ChargeEmitter_C
{
public:
	class UAudioComponent*                             ChargeOffSound;                                           // 0x0AB8(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UAudioComponent*                             ChargeOnSound;                                            // 0x0AC0(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               WasMaxChargeLastTick;                                     // 0x0AC8(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
