...
// 0x0024 (0x098C - 0x0968)
class ABuff_ChargeStun_AoE_C : public ABuff_Base_AoE_C
{
public:
	float                                              maxDragWeightToApplyStunBuff;                             // 0x0968(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData00[0x4];                                       // 0x096C(0x0004) MISSED OFFSET
	class ABuff_ChargeManager_C*                       chargeManagerOwner;                                       // 0x0970(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, IsPlainOldData)
	bool                                               AoEInitialized;                                           // 0x0978(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData01[0x7];                                       // 0x0979(0x0007) MISSED OFFSET
	class UClass*                                      immuneToStunBuff;                                         // 0x0980(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
