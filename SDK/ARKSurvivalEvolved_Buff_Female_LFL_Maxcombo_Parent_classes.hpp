...
#include "ARKSurvivalEvolved_Buff_Female_LFL_Maxcombo_Parent_structs.hpp"
...
// BlueprintGeneratedClass Buff_Female_LFL_Maxcombo_Parent.Buff_Female_LFL_Maxcombo_Parent_C
// 0x001A (0x097A - 0x0960)
class ABuff_Female_LFL_Maxcombo_Parent_C : public ABuff_Base_Disease_Low_C
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Buff_Female_LFL_Maxcombo_Parent.Buff_Female_LFL_Maxcombo_Parent_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_Buff_Female_LFL_Maxcombo_Parent(int EntryPoint);
};
