...
// (NetRequest, Exec, Event, NetResponse, Static, MulticastDelegate, Public, HasOutParms, HasDefaults, BlueprintEvent)
// Parameters:
// float*                         DeltaTime                      (Parm, ZeroConstructor, IsPlainOldData)

void ABuff_GrabbedByBeam_C::STATIC_BuffTickServer(float* DeltaTime)
{
