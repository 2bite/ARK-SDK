...
// 0x0061 (0x09B1 - 0x0950)
class ABuff_HazardSuitHelmet_C : public ABuff_HazardSuit_Base_C
{
public:
	TArray<class UClass*>                              HazardSuitItems;                                          // 0x0950(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
	class UMaterialInstanceDynamic*                    PostProcessMat;                                           // 0x0960(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	TArray<class UClass*>                              MonitorBuffClasses;                                       // 0x0968(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
	...
	class APawn*                                       CallFunc_GetInstigator_ReturnValue;                       // 0x0990(0x0008) (ZeroConstructor, Transient, DuplicateTransient, IsPlainOldData)
	...
	class APrimalBuff*                                 CallFunc_GetBuff_ReturnValue;                             // 0x09A8(0x0008) (ZeroConstructor, Transient, DuplicateTransient, IsPlainOldData)
	bool                                               CallFunc_IsValid_ReturnValue;                             // 0x09B0(0x0001) (ZeroConstructor, Transient, DuplicateTransient, IsPlainOldData)
