...
// (NetRequest, NetResponse, Static, NetMulticast, Public, HasOutParms, NetClient, BlueprintCallable, Const, NetValidate)
// Parameters:
...
// (NetRequest, Event, Static, NetMulticast, Public, HasOutParms, NetClient, BlueprintCallable, Const, NetValidate)

void ABuff_HordeRouteManager_C::STATIC_InitiateRoute()
{
