...
{
public:
	class UClass*                                      DebuffClassWhenEnemyExitsShield;                          // 0x08A0(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              FriendlyReceiveDamageMultiplier;                          // 0x08A8(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bIsFromFriendlyMek;                                       // 0x08AC(0x0001) (Edit, BlueprintVisible, Net, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
