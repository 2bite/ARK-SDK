...
void ABuff_LightningAoE_C::ReceiveEndPlay(TEnumAsByte<EEndPlayReason>* EndPlayReason)
{
	static auto fn = UObject::FindObject<UFunction>("Function Buff_LightningAoE.Buff_LightningAoE_C.ReceiveEndPlay");
