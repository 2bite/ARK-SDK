...
public:
	...
	class UMaterialInstanceDynamic*                    NearlyOverheatPostProcess;                                // 0x0980(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class UCurveFloat*                                 StaminaPercentToNearlyOverheatPostProcessIntensity_Curve; // 0x0988(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class UCurveFloat*                                 StaminaPercentToNearlyOverheatParticleIntensity_Curve;    // 0x0990(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
