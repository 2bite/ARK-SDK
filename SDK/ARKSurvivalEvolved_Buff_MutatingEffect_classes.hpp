...
#include "ARKSurvivalEvolved_Buff_MutatingEffect_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Buff_MutatingEffect.Buff_MutatingEffect_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_Buff_MutatingEffect(int EntryPoint);
};
