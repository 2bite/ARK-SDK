...
#include "ARKSurvivalEvolved_Buff_RiderFlyingWindWoosh_LionfishLion_classes.hpp"
...
struct ABuff_RiderFlyingWindWoosh_LionfishLion_C_AllowPostProcessEffect_Params
{
...
struct ABuff_RiderFlyingWindWoosh_LionfishLion_C_GetBuffPostprocessIntensity_Params
{
	float                                              ReturnValue;                                              // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Buff_RiderFlyingWindWoosh_LionfishLion.Buff_RiderFlyingWindWoosh_LionfishLion_C.BuffTickClient
struct ABuff_RiderFlyingWindWoosh_LionfishLion_C_BuffTickClient_Params
{
...
struct ABuff_RiderFlyingWindWoosh_LionfishLion_C_UserConstructionScript_Params
{
};
...
struct ABuff_RiderFlyingWindWoosh_LionfishLion_C_ExecuteUbergraph_Buff_RiderFlyingWindWoosh_LionfishLion_Params
{
