...
// (NetReliable, NetRequest, Exec, Event, NetResponse, Static, NetMulticast, Private, Protected, Delegate, NetServer, HasOutParms, HasDefaults, BlueprintCallable, Const)
// Parameters:
// bool                           from_animbp                    (Parm, ZeroConstructor, IsPlainOldData)
// bool                           ReturnValue                    (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)

bool ABuff_TekStrider_LargeCannon_C::STATIC_is_cannon_blocked(bool from_animbp)
{
...
// (NetRequest, Exec, Native, MulticastDelegate, Protected, Delegate, NetServer, HasOutParms, HasDefaults, BlueprintCallable, Const)

void ABuff_TekStrider_LargeCannon_C::Delay_Check_for_Valid_Shot_Loc()
{
...
// (NetReliable, NetRequest, Exec, Native, NetResponse, MulticastDelegate, Protected, Delegate, NetServer, HasOutParms, HasDefaults, BlueprintCallable, Const)
// Parameters:
...
void ABuff_TekStrider_LargeCannon_C::get_start_and_end_location(bool use_passed_in_loc, struct FVector* EndPoint)
{
...
// (NetRequest, Event, Static, NetMulticast, Public, Protected, Delegate, NetServer, HasOutParms, HasDefaults, BlueprintCallable, Const)
// Parameters:
// class APlayerController**      ForPC                          (Parm, ZeroConstructor, IsPlainOldData)
// TArray<struct FHUDElement>     OutElements                    (Parm, OutParm, ZeroConstructor)

void ABuff_TekStrider_LargeCannon_C::STATIC_BPGetHUDElements(class APlayerController** ForPC, TArray<struct FHUDElement>* OutElements)
{
...
// (Event, Static, NetMulticast, MulticastDelegate, Protected, Delegate, NetServer, HasOutParms, HasDefaults, BlueprintCallable, Const)
// Parameters:
// class AActor**                 ForInstigator                  (Parm, ZeroConstructor, IsPlainOldData)

void ABuff_TekStrider_LargeCannon_C::STATIC_BPSetupForInstigator(class AActor** ForInstigator)
{
