...
#include "ARKSurvivalEvolved_Buff_Thornmail_Parent_classes.hpp"
...
struct ABuff_Thornmail_Parent_C_BPDeactivated_Params
{
	class AActor**                                     ForInstigator;                                            // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Buff_Thornmail_Parent.Buff_Thornmail_Parent_C.CalculateDoTDamage
struct ABuff_Thornmail_Parent_C_CalculateDoTDamage_Params
{
...
struct ABuff_Thornmail_Parent_C_BuffTickServer_Params
{
	float*                                             DeltaTime;                                                // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Buff_Thornmail_Parent.Buff_Thornmail_Parent_C.Do Damage Over TimeFn
struct ABuff_Thornmail_Parent_C_Do_Damage_Over_TimeFn_Params
{
...
struct ABuff_Thornmail_Parent_C_BPAdjustStatusValueModification_Params
{
