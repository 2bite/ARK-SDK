...
public:
	...
	bool                                               CallFunc_IsWithinAttackRange_ReturnValue;                 // 0x0929(0x0001) (ZeroConstructor, Transient, DuplicateTransient, IsPlainOldData)
	...
	class AActor*                                      CallFunc_FindNewTarget_ReturnValue;                       // 0x0930(0x0008) (ZeroConstructor, Transient, DuplicateTransient, IsPlainOldData)
