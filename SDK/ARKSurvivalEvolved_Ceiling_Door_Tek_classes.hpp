...
// 0x001B (0x0D28 - 0x0D0D)
class ACeiling_Door_Tek_C : public ADoor_Tek_Base_C
{
public:
	unsigned char                                      UnknownData00[0x3];                                       // 0x0D0D(0x0003) MISSED OFFSET
	class UStaticMeshComponent*                        StaticMesh1;                                              // 0x0D10(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class USphereComponent*                            Sphere1;                                                  // 0x0D18(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UStaticMeshComponent*                        StaticMesh2;                                              // 0x0D20(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
