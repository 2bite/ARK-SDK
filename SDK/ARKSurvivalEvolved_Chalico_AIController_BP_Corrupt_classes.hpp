...
#include "ARKSurvivalEvolved_Chalico_AIController_BP_Corrupt_structs.hpp"
...
// BlueprintGeneratedClass Chalico_AIController_BP_Corrupt.Chalico_AIController_BP_Corrupt_C
// 0x0027 (0x0910 - 0x08E9)
class AChalico_AIController_BP_Corrupt_C : public AChalico_AIController_BP_C
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Chalico_AIController_BP_Corrupt.Chalico_AIController_BP_Corrupt_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_Chalico_AIController_BP_Corrupt(int EntryPoint);
};
