...
// Function Chalico_AIController_BP_Corrupt.Chalico_AIController_BP_Corrupt_C.BPShouldNotifyAnyNeighbor
// ()
// Parameters:
// class APrimalDinoCharacter**   neighbor                       (Parm, ZeroConstructor, IsPlainOldData)
// bool                           ReturnValue                    (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)

bool AChalico_AIController_BP_Corrupt_C::BPShouldNotifyAnyNeighbor(class APrimalDinoCharacter** neighbor)
{
	static auto fn = UObject::FindObject<UFunction>("Function Chalico_AIController_BP_Corrupt.Chalico_AIController_BP_Corrupt_C.BPShouldNotifyAnyNeighbor");

	AChalico_AIController_BP_Corrupt_C_BPShouldNotifyAnyNeighbor_Params params;
