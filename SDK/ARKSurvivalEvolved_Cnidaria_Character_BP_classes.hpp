...
{
public:
	class UDinoCharacterStatusComponent_BP_Cnidaria_C* DinoCharacterStatus_BP_Cnidaria_C1;                       // 0x2268(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UPointLightComponent*                        ColorLight;                                               // 0x2270(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
