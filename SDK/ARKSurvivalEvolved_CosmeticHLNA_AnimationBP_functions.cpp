...
#include "ARKSurvivalEvolved_CosmeticHLNA_AnimationBP_parameters.hpp"
...
void UCosmeticHLNA_AnimationBP_C::BlueprintUpdateAnimation(float* DeltaTimeX)
{
	static auto fn = UObject::FindObject<UFunction>("Function CosmeticHLNA_AnimationBP.CosmeticHLNA_AnimationBP_C.BlueprintUpdateAnimation");

	UCosmeticHLNA_AnimationBP_C_BlueprintUpdateAnimation_Params params;
...
void UCosmeticHLNA_AnimationBP_C::ExecuteUbergraph_CosmeticHLNA_AnimationBP(int EntryPoint)
{
	static auto fn = UObject::FindObject<UFunction>("Function CosmeticHLNA_AnimationBP.CosmeticHLNA_AnimationBP_C.ExecuteUbergraph_CosmeticHLNA_AnimationBP");

	UCosmeticHLNA_AnimationBP_C_ExecuteUbergraph_CosmeticHLNA_AnimationBP_Params params;
