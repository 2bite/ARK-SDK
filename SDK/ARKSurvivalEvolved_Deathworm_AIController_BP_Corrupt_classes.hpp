...
#include "ARKSurvivalEvolved_Deathworm_AIController_BP_Corrupt_structs.hpp"
...
// BlueprintGeneratedClass Deathworm_AIController_BP_Corrupt.Deathworm_AIController_BP_Corrupt_C
// 0x0027 (0x0940 - 0x0919)
class ADeathworm_AIController_BP_Corrupt_C : public ADeathworm_AIController_BP_C
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Deathworm_AIController_BP_Corrupt.Deathworm_AIController_BP_Corrupt_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_Deathworm_AIController_BP_Corrupt(int EntryPoint);
};
