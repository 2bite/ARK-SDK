...
#include "ARKSurvivalEvolved_Deco_FlyerIsBlocked_structs.hpp"
...
// BlueprintGeneratedClass Deco_FlyerIsBlocked.Deco_FlyerIsBlocked_C
// 0x002A (0x00BA - 0x0090)
class UDeco_FlyerIsBlocked_C : public UBTDecorator_BlueprintBase
{
public:
	...
	bool                                               CallFunc_NearlyEqual_VectorVector_ReturnValue;            // 0x00B9(0x0001) (ZeroConstructor, Transient, DuplicateTransient, IsPlainOldData)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Deco_FlyerIsBlocked.Deco_FlyerIsBlocked_C");
		return ptr;
	}


	void ReceiveConditionCheck(class AActor** OwnerActor);
	void ExecuteUbergraph_Deco_FlyerIsBlocked(int EntryPoint);
};
