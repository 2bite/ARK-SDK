...
#include "ARKSurvivalEvolved_Deco_IsFlyerDino_structs.hpp"
...
class UDeco_IsFlyerDino_C : public UBTDecorator_BlueprintBase
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Deco_IsFlyerDino.Deco_IsFlyerDino_C");
		return ptr;
	}


	void ReceiveConditionCheck(class AActor** OwnerActor);
	void ExecuteUbergraph_Deco_IsFlyerDino(int EntryPoint);
};
