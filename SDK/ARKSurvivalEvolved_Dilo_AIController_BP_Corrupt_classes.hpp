...
#include "ARKSurvivalEvolved_Dilo_AIController_BP_Corrupt_structs.hpp"
...
// BlueprintGeneratedClass Dilo_AIController_BP_Corrupt.Dilo_AIController_BP_Corrupt_C
// 0x0027 (0x0910 - 0x08E9)
class ADilo_AIController_BP_Corrupt_C : public ADino_AIController_BP_C
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Dilo_AIController_BP_Corrupt.Dilo_AIController_BP_Corrupt_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_Dilo_AIController_BP_Corrupt(int EntryPoint);
};
