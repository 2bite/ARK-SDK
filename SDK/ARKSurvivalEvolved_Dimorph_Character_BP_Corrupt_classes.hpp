...
#include "ARKSurvivalEvolved_Dimorph_Character_BP_Corrupt_structs.hpp"
...
// BlueprintGeneratedClass Dimorph_Character_BP_Corrupt.Dimorph_Character_BP_Corrupt_C
// 0x0063 (0x20F3 - 0x2090)
class ADimorph_Character_BP_Corrupt_C : public ADimorph_Character_BP_C
{
public:
	class UAudioComponent*                             CorruptedSFX;                                             // 0x2090(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UMaterialInstanceDynamic*                    CorruptFurDMIC;                                           // 0x2098(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class UMaterialInstanceDynamic*                    BodyDMIC;                                                 // 0x20A0(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Dimorph_Character_BP_Corrupt.Dimorph_Character_BP_Corrupt_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_Dimorph_Character_BP_Corrupt(int EntryPoint);
};
