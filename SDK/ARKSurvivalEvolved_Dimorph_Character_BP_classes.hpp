...
#include "ARKSurvivalEvolved_Dimorph_Character_BP_structs.hpp"
...
{
public:
	class UDinoCharacterStatusComponent_BP_Dimorph_C*  DinoCharacterStatus_BP_Dimorph_C1;                        // 0x2288(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
