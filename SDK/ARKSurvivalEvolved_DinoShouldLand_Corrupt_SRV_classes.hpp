...
#include "ARKSurvivalEvolved_DinoShouldLand_Corrupt_SRV_structs.hpp"
...
// BlueprintGeneratedClass DinoShouldLand_Corrupt_SRV.DinoShouldLand_Corrupt_SRV_C
// 0x00C1 (0x0141 - 0x0080)
class UDinoShouldLand_Corrupt_SRV_C : public UBTService_BlueprintBase
{
public:
	...
	bool                                               CallFunc_GetBlackboardValueAsBool_ReturnValue;            // 0x00FC(0x0001) (ZeroConstructor, Transient, DuplicateTransient, IsPlainOldData)
	bool                                               CallFunc_Not_PreBool_ReturnValue;                         // 0x00FD(0x0001) (ZeroConstructor, Transient, DuplicateTransient, IsPlainOldData)
	...
	bool                                               CallFunc_BooleanAND_ReturnValue;                          // 0x012A(0x0001) (ZeroConstructor, Transient, DuplicateTransient, IsPlainOldData)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass DinoShouldLand_Corrupt_SRV.DinoShouldLand_Corrupt_SRV_C");
		return ptr;
	}


	void ReceiveTick(class AActor** OwnerActor, float* DeltaSeconds);
	void ExecuteUbergraph_DinoShouldLand_Corrupt_SRV(int EntryPoint);
};
