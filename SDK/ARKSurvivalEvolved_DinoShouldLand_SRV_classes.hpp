...
#include "ARKSurvivalEvolved_DinoShouldLand_SRV_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass DinoShouldLand_SRV.DinoShouldLand_SRV_C");
		return ptr;
	}


	void ReceiveTick(class AActor** OwnerActor, float* DeltaSeconds);
	void ExecuteUbergraph_DinoShouldLand_SRV(int EntryPoint);
};
