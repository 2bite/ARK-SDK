...
{
public:
	class UDinoCharacterStatusComponent_BP_Diplodocus_C* DinoCharacterStatus_BP_Diplodocus_C1;                     // 0x2198(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
