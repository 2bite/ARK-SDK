...
#include "ARKSurvivalEvolved_DmgType_Melee_Dino_Carnivore_Small_Electrocute_Eel_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass DmgType_Melee_Dino_Carnivore_Small_Electrocute_Eel.DmgType_Melee_Dino_Carnivore_Small_Electrocute_Eel_C");
		return ptr;
	}
