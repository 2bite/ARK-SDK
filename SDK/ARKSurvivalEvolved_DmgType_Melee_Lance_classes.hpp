...
#include "ARKSurvivalEvolved_DmgType_Melee_Lance_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass DmgType_Melee_Lance.DmgType_Melee_Lance_C");
		return ptr;
	}
