...
#include "ARKSurvivalEvolved_DmgType_Melee_Torpidity_Low_Dismount_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass DmgType_Melee_Torpidity_Low_Dismount.DmgType_Melee_Torpidity_Low_Dismount_C");
		return ptr;
	}
