...
#include "ARKSurvivalEvolved_DmgType_Projectile_IceSpear_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass DmgType_Projectile_IceSpear.DmgType_Projectile_IceSpear_C");
		return ptr;
	}
