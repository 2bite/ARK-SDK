...
#include "ARKSurvivalEvolved_DmgType_Projectile_TekWyvern_Breath_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass DmgType_Projectile_TekWyvern_Breath.DmgType_Projectile_TekWyvern_Breath_C");
		return ptr;
	}
