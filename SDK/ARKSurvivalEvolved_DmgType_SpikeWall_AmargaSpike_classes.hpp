...
#include "ARKSurvivalEvolved_DmgType_SpikeWall_AmargaSpike_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass DmgType_SpikeWall_AmargaSpike.DmgType_SpikeWall_AmargaSpike_C");
		return ptr;
	}
