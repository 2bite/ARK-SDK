...
public:
	...
	class UDinoCharacterStatusComponent_BP_DragonBoss_Easy_C* DinoCharacterStatus_BP_DragonBoss_Easy_C1;                // 0x2380(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
