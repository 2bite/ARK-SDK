...
public:
	...
	class UDinoCharacterStatusComponent_BP_DragonBoss_Hard_C* DinoCharacterStatus_BP_DragonBoss_Hard_C1;                // 0x2370(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
