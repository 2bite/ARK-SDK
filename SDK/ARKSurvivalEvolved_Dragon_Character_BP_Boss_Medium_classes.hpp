...
public:
	...
	class UDinoCharacterStatusComponent_BP_DragonBoss_Medium_C* DinoCharacterStatus_BP_DragonBoss_Medium_C1;              // 0x22F0(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
