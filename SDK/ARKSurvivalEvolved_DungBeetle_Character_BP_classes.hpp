...
// 0x0031 (0x2299 - 0x2268)
class ADungBeetle_Character_BP_C : public ADino_Character_BP_RepelType_C
{
public:
	class UDinoCharacterStatusComponent_BP_Beetle_C*   DinoCharacterStatus_BP_Beetle_C1;                         // 0x2268(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FScriptDelegate                             K2Node_CreateDelegate_OutputDelegate;                     // 0x2270(0x0014) (ZeroConstructor, Transient, DuplicateTransient)
	class APrimalCharacter*                            K2Node_CustomEvent_DiedCharacter;                         // 0x2280(0x0008) (ZeroConstructor, Transient, DuplicateTransient, IsPlainOldData)
	...
	class UDinoTamedInventoryComponent_Beetle_C*       K2Node_DynamicCast_AsDinoTamedInventoryComponent_Beetle_C;// 0x2290(0x0008) (ZeroConstructor, Transient, DuplicateTransient, IsPlainOldData)
