...
// 0x0031 (0x21C9 - 0x2198)
class ADungBeetle_Character_BP_C : public ADino_Character_BP_RepelType_C
{
public:
	class UDinoCharacterStatusComponent_BP_Beetle_C*   DinoCharacterStatus_BP_Beetle_C1;                         // 0x2198(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	bool                                               CallFunc_IsServer_ReturnValue;                            // 0x21B8(0x0001) (ZeroConstructor, Transient, DuplicateTransient, IsPlainOldData)
	unsigned char                                      UnknownData00[0x7];                                       // 0x21B9(0x0007) MISSED OFFSET
	class UDinoTamedInventoryComponent_Beetle_C*       K2Node_DynamicCast_AsDinoTamedInventoryComponent_Beetle_C;// 0x21C0(0x0008) (ZeroConstructor, Transient, DuplicateTransient, IsPlainOldData)
	bool                                               K2Node_DynamicCast_CastSuccess;                           // 0x21C8(0x0001) (ZeroConstructor, Transient, DuplicateTransient, IsPlainOldData)
