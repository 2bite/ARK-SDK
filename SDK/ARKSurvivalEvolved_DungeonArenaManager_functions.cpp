...
// (NetReliable, Exec, Event, NetResponse, Static, NetMulticast, Public, Protected, Delegate, NetServer, HasOutParms, HasDefaults, NetClient, BlueprintEvent, Const)
// Parameters:
...
// (NetReliable, NetResponse, Static, NetMulticast, MulticastDelegate, Public, NetServer, HasDefaults, NetClient, BlueprintEvent, BlueprintPure, NetValidate)

void ADungeonArenaManager_C::STATIC_IssueTimeWarning()
{
