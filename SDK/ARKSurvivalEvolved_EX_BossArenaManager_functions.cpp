...
// (NetReliable, NetRequest, NetResponse, MulticastDelegate, Public, Private, Protected, NetServer, HasOutParms, NetClient, DLLImport, BlueprintCallable)
...
// (Net, Exec, MulticastDelegate, Private, NetServer, NetClient, DLLImport, BlueprintCallable, Const, NetValidate)
// Parameters:
...
// (NetReliable, NetRequest, Exec, Native, NetResponse, NetMulticast, Private, Protected, NetServer, HasOutParms, DLLImport, BlueprintCallable)

void AEX_BossArenaManager_C::IssueTimeWarning()
{
...
// (Native, Event, Static, Private, Protected, NetServer, HasOutParms, DLLImport, BlueprintCallable)

void AEX_BossArenaManager_C::STATIC_UserConstructionScript()
{
