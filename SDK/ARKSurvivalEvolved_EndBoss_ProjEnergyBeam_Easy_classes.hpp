...
#include "ARKSurvivalEvolved_EndBoss_ProjEnergyBeam_Easy_structs.hpp"
...
// BlueprintGeneratedClass EndBoss_ProjEnergyBeam_Easy.EndBoss_ProjEnergyBeam_Easy_C
// 0x007F (0x0B20 - 0x0AA1)
class AEndBoss_ProjEnergyBeam_Easy_C : public AEndBoss_ProjEnergyBeam_C
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass EndBoss_ProjEnergyBeam_Easy.EndBoss_ProjEnergyBeam_Easy_C");
		return ptr;
	}


	void UserConstructionScript();
	void ExecuteUbergraph_EndBoss_ProjEnergyBeam_Easy(int EntryPoint);
};
