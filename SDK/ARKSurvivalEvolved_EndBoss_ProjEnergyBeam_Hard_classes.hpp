...
#include "ARKSurvivalEvolved_EndBoss_ProjEnergyBeam_Hard_structs.hpp"
...
// BlueprintGeneratedClass EndBoss_ProjEnergyBeam_Hard.EndBoss_ProjEnergyBeam_Hard_C
// 0x007F (0x0B20 - 0x0AA1)
class AEndBoss_ProjEnergyBeam_Hard_C : public AEndBoss_ProjEnergyBeam_C
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass EndBoss_ProjEnergyBeam_Hard.EndBoss_ProjEnergyBeam_Hard_C");
		return ptr;
	}


	void UserConstructionScript();
	void ExecuteUbergraph_EndBoss_ProjEnergyBeam_Hard(int EntryPoint);
};
