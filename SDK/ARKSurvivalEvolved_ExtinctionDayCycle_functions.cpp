...
// (NetReliable, NetRequest, Event, Static, NetMulticast, Public, Private, NetServer, HasDefaults, NetClient, Const, NetValidate)
// Parameters:
...
void AExtinctionDayCycle_C::IsActorIntoBossElectricalStorm(class AActor* Actor, bool* Return)
{
