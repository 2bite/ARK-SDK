...
#include "ARKSurvivalEvolved_Furniture_ChristmasTree_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Furniture_ChristmasTree.Furniture_ChristmasTree_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_Furniture_ChristmasTree(int EntryPoint);
};
