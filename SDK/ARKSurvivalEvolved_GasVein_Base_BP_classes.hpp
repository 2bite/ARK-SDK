...
// 0x01B8 (0x0C98 - 0x0AE0)
class AGasVein_Base_BP_C : public AWaterPipe_Base_Straight_C
{
public:
	class UAudioComponent*                             Idle_SFX;                                                 // 0x0AE0(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UParticleSystemComponent*                    PS_PoisonGas;                                             // 0x0AE8(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UClass*                                      BuffToApply;                                              // 0x0AF0(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bTimerSet;                                                // 0x0AF8(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0AF9(0x0003) MISSED OFFSET
	float                                              MinTimeBetweenBursts;                                     // 0x0AFC(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              MaxTimeBetweenBursts;                                     // 0x0B00(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              BurstTimeLength;                                          // 0x0B04(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              BurstOverlapRadius;                                       // 0x0B08(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData01[0x4];                                       // 0x0B0C(0x0004) MISSED OFFSET
	double                                             LastBurstTime;                                            // 0x0B10(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	int                                                MinDroppedGasQuantity;                                    // 0x0B18(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	int                                                MaxDroppedGasQuantity;                                    // 0x0B1C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	...
	unsigned char                                      UnknownData03[0xC];                                       // 0x0B94(0x000C) MISSED OFFSET
	...
	unsigned char                                      UnknownData05[0x4];                                       // 0x0C14(0x0004) MISSED OFFSET
	...
	unsigned char                                      UnknownData06[0x7];                                       // 0x0C21(0x0007) MISSED OFFSET
	...
	unsigned char                                      UnknownData07[0x7];                                       // 0x0C31(0x0007) MISSED OFFSET
