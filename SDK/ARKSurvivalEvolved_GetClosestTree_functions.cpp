...
// (NetReliable, Native, Event, NetResponse, Static, MulticastDelegate, Public, NetServer, BlueprintCallable, BlueprintEvent)
// Parameters:
...
// (NetRequest, Native, NetResponse, NetMulticast, MulticastDelegate, Public, NetServer, BlueprintCallable, BlueprintEvent)
// Parameters:
...
// (NetReliable, NetRequest, Native, Static, NetMulticast, MulticastDelegate, Public, NetServer, BlueprintCallable, BlueprintEvent)
// Parameters:
// class AActor**                 OwnerActor                     (Parm, ZeroConstructor, IsPlainOldData)
