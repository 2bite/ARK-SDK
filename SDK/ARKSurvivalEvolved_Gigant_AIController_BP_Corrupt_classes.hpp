...
#include "ARKSurvivalEvolved_Gigant_AIController_BP_Corrupt_structs.hpp"
...
// BlueprintGeneratedClass Gigant_AIController_BP_Corrupt.Gigant_AIController_BP_Corrupt_C
// 0x0027 (0x0910 - 0x08E9)
class AGigant_AIController_BP_Corrupt_C : public ADino_AIController_BP_C
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Gigant_AIController_BP_Corrupt.Gigant_AIController_BP_Corrupt_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_Gigant_AIController_BP_Corrupt(int EntryPoint);
};
