...
public:
	...
	class UDinoCharacterStatusComponent_BP_Gorilla_Easy_C* DinoCharacterStatus_BP_Gorilla_Easy_C1;                   // 0x2230(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
