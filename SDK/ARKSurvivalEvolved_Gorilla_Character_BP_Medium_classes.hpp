...
public:
	...
	class UDinoCharacterStatusComponent_BP_Gorilla_Medium_C* DinoCharacterStatus_BP_Gorilla_Medium_C1;                 // 0x21A0(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
