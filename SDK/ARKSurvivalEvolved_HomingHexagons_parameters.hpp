...
#include "ARKSurvivalEvolved_HomingHexagons_classes.hpp"
...
struct AHomingHexagons_C_Spread_Out_Params
{
};
...
struct AHomingHexagons_C_constantly_rotate_Params
{
};
...
struct AHomingHexagons_C_begin_move_towards_screen_position_Params
{
};

// Function HomingHexagons.HomingHexagons_C.begin moving towards point in screen space
struct AHomingHexagons_C_begin_moving_towards_point_in_screen_space_Params
{
...
struct AHomingHexagons_C_begin_moving_towards_point_attached_to_actor_Params
{
	class AActor*                                      Attach_Actor;                                             // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function HomingHexagons.HomingHexagons_C.skip hover
struct AHomingHexagons_C_skip_hover_Params
{
};
