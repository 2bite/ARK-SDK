...
// (NetRequest, Native, Static, NetMulticast, Private, Protected, HasDefaults, DLLImport)
// Parameters:
// class AActor*                  TheCrate                       (Parm, ZeroConstructor, IsPlainOldData)

void AHordeCrateManager_Extinction_C::STATIC_EndActiveEvent(class AActor* TheCrate)
{
...
// (NetReliable, NetRequest, Exec, Event, Static, NetMulticast, Private, Protected, HasDefaults, DLLImport)

void AHordeCrateManager_Extinction_C::STATIC_CreateActiveEvent()
{
...
// (Private, Protected, HasDefaults, DLLImport)
// Parameters:
...
// (NetRequest, Exec, Native, NetResponse, NetMulticast, Public, Private, Delegate, DLLImport)
// Parameters:
...
void AHordeCrateManager_Extinction_C::Get_Avail_Networks_Of_Difficulty(int InDifficulty, TArray<class AHordeSpawnNetwork_C*>* NetworksPreferred, TArray<class AHordeSpawnNetwork_C*>* NetworksNotPreferred)
{
...
// (NetRequest, Event, NetResponse, Static, NetMulticast, Public, Private, Delegate, DLLImport)
// Parameters:
...
void AHordeCrateManager_Extinction_C::STATIC_Find_Random_Spawn_Network(class AHordeSpawnNetwork_C** RetHordeNetwork, bool* bIsStassised)
{
...
// (NetRequest, Event, NetResponse, Static, Public, Private, Delegate, DLLImport)
// Parameters:
...
void AHordeCrateManager_Extinction_C::STATIC_GetActiveEvents(int DifficultyLevel, bool* bAnyActiveEvents, TArray<struct FHordeCrateEvent>* VarEvents)
{
...
// (Exec, Native, Static, NetMulticast, Public, Private, Delegate, DLLImport)
// Parameters:
