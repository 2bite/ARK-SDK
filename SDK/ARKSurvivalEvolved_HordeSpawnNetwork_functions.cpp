...
// (NetRequest, Exec, Event, NetMulticast, Private, Protected, HasOutParms, NetClient, BlueprintEvent, Const, NetValidate)
// Parameters:
...
void AHordeSpawnNetwork_C::GetOriginSplinePoints(class AHorde_Spline_Path_C* LastSpline, struct FVector* OutLoc, class AHorde_Spline_Path_C** SplineData, float* DelayTime)
{
...
// (Exec, Native, Event, NetResponse, Static, NetMulticast, Private, Protected, HasOutParms, NetClient, BlueprintEvent, Const, NetValidate)
// Parameters:
...
// (NetReliable, Exec, Native, Event, NetResponse, MulticastDelegate, Public, Protected, Delegate, HasOutParms, NetClient, DLLImport, Const, NetValidate)
// Parameters:
...
// (NetReliable, Exec, Event, NetMulticast, MulticastDelegate, Public, Protected, Delegate, HasOutParms, NetClient, DLLImport, Const, NetValidate)
// Parameters:
// int                            RingIndex                      (Parm, ZeroConstructor, IsPlainOldData)
// struct FSpawnPointStruct       RetNodes                       (Parm, OutParm)

void AHordeSpawnNetwork_C::GetValidOriginPoints(int RingIndex, struct FSpawnPointStruct* RetNodes)
{
...
// (NetReliable, Static, NetMulticast, MulticastDelegate, Public, Protected, Delegate, HasOutParms, NetClient, DLLImport, Const, NetValidate)

void AHordeSpawnNetwork_C::STATIC_Evaluate_Points()
{
...
// (Exec, MulticastDelegate, Public, Protected, Delegate, HasOutParms, NetClient, DLLImport, Const, NetValidate)
// Parameters:
...
void AHordeSpawnNetwork_C::GetNearbyPoints(const struct FSpawnPointStruct& In, int ArrayIndex, TArray<struct FSpawnPointStruct>* Points)
{
...
// (NetRequest, Exec, Event, NetMulticast, MulticastDelegate, Public, Protected, Delegate, HasOutParms, NetClient, DLLImport, Const, NetValidate)
...
// (Exec, NetResponse, NetMulticast, MulticastDelegate, Public, Protected, Delegate, HasOutParms, NetClient, DLLImport, Const, NetValidate)
// Parameters:
...
// (NetResponse, Static, NetMulticast, MulticastDelegate, Public, Protected, Delegate, HasOutParms, NetClient, DLLImport, Const, NetValidate)
// Parameters:
...
void AHordeSpawnNetwork_C::STATIC_GenerateRing(float RadiusInput, int NumOfPoints, int Radiuslevel)
{
