...
#include "ARKSurvivalEvolved_HoverSkiffHudWidget_classes.hpp"
...
struct UHoverSkiffHudWidget_C_Update_Status_Visibilities_Params
{
};
...
struct UHoverSkiffHudWidget_C_Update_Tractor_Beam_Crosshair_Visuals_Params
{
};
...
struct UHoverSkiffHudWidget_C_Get_Debug_Text_0_Params
{
	struct FText                                       ReturnValue;                                              // (Parm, OutParm, ReturnParm)
};
...
struct UHoverSkiffHudWidget_C_Set_Progress_Bar_Fill_And_Background_Colors_Params
{
...
struct UHoverSkiffHudWidget_C_Get_Tractor_Progress_Bar_Percent__Params
{
