...
#include "ARKSurvivalEvolved_IsFlyingPhysics_structs.hpp"
...
// BlueprintGeneratedClass IsFlyingPhysics.IsFlyingPhysics_C
// 0x002A (0x00BA - 0x0090)
class UIsFlyingPhysics_C : public UBTDecorator_BlueprintBase
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass IsFlyingPhysics.IsFlyingPhysics_C");
		return ptr;
	}


	void ReceiveConditionCheck(class AActor** OwnerActor);
	void ExecuteUbergraph_IsFlyingPhysics(int EntryPoint);
};
