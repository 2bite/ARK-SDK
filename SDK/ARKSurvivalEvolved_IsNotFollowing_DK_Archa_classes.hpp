...
#include "ARKSurvivalEvolved_IsNotFollowing_DK_Archa_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass IsNotFollowing_DK_Archa.IsNotFollowing_DK_Archa_C");
		return ptr;
	}


	void ReceiveConditionCheck(class AActor** OwnerActor);
	void ExecuteUbergraph_IsNotFollowing_DK_Archa(int EntryPoint);
};
