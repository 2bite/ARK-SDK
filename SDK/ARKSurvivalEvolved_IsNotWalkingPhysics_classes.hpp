...
#include "ARKSurvivalEvolved_IsNotWalkingPhysics_structs.hpp"
...
// BlueprintGeneratedClass IsNotWalkingPhysics.IsNotWalkingPhysics_C
// 0x002B (0x00BB - 0x0090)
class UIsNotWalkingPhysics_C : public UBTDecorator_BlueprintBase
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass IsNotWalkingPhysics.IsNotWalkingPhysics_C");
		return ptr;
	}


	void ReceiveConditionCheck(class AActor** OwnerActor);
	void ExecuteUbergraph_IsNotWalkingPhysics(int EntryPoint);
};
