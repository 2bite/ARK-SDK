...
#include "ARKSurvivalEvolved_IsWithinDistanceFromGround_WanderMinZ_DK_structs.hpp"
...
// BlueprintGeneratedClass IsWithinDistanceFromGround_WanderMinZ_DK.IsWithinDistanceFromGround_WanderMinZ_DK_C
// 0x0169 (0x01F9 - 0x0090)
class UIsWithinDistanceFromGround_WanderMinZ_DK_C : public UBTDecorator_BlueprintBase
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass IsWithinDistanceFromGround_WanderMinZ_DK.IsWithinDistanceFromGround_WanderMinZ_DK_C");
		return ptr;
	}


	void ReceiveConditionCheck(class AActor** OwnerActor);
	void ExecuteUbergraph_IsWithinDistanceFromGround_WanderMinZ_DK(int EntryPoint);
};
