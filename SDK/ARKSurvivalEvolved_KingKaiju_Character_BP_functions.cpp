...
void AKingKaiju_Character_BP_C::GetVar_DifficultyIndex(int* _return)
{
...
void AKingKaiju_Character_BP_C::GetVar_InHordeMode(bool* _return)
{
...
// (NetReliable, Exec, Event, NetResponse, NetMulticast, HasDefaults, BlueprintPure, Const, NetValidate)
// Parameters:
// struct FName                   Socket                         (Parm, ZeroConstructor, IsPlainOldData)

void AKingKaiju_Character_BP_C::DoStepDmg(const struct FName& Socket)
{
...
// (Exec, Native, Static, NetMulticast, HasDefaults, BlueprintPure, Const, NetValidate)
...
// (Exec, Native, Event, Static, NetMulticast, HasDefaults, BlueprintPure, Const, NetValidate)
// Parameters:
...
// (NetReliable, Exec, NetResponse, Static, NetMulticast, HasDefaults, BlueprintPure, Const, NetValidate)

void AKingKaiju_Character_BP_C::STATIC_TraceLeftHandChargeCapsule()
{
...
// (NetRequest, NetResponse, Public, Private, Protected, Delegate, NetServer, HasOutParms, BlueprintPure, Const, NetValidate)
...
// (Net, NetReliable, NetRequest, Native, MulticastDelegate, Public, Protected, Delegate, NetServer, HasOutParms, BlueprintPure, Const, NetValidate)
// Parameters:
// int                            InIndex                        (Parm, ZeroConstructor, IsPlainOldData)
// int                            InState                        (Parm, ZeroConstructor, IsPlainOldData)

void AKingKaiju_Character_BP_C::UpdateDamageStateFX(int InIndex, int InState)
{
...
// (NetReliable, NetRequest, Exec, Event, Static, Public, Private, Protected, Delegate, NetServer, HasOutParms, BlueprintPure, Const, NetValidate)
// Parameters:
...
// (NetReliable, NetRequest, Exec, NetMulticast, Public, Private, Protected, Delegate, NetServer, HasOutParms, BlueprintPure, Const, NetValidate)
// Parameters:
...
// (Event, NetMulticast, Public, Private, Protected, Delegate, NetServer, HasOutParms, BlueprintPure, Const, NetValidate)
// Parameters:
...
// (NetReliable, NetRequest, NetResponse, NetMulticast, Public, Private, Protected, Delegate, NetServer, HasOutParms, BlueprintPure, Const, NetValidate)
...
// (NetReliable, NetRequest, Event, NetResponse, NetMulticast, Public, Private, Protected, Delegate, NetServer, HasOutParms, BlueprintPure, Const, NetValidate)
// Parameters:
// class AActor*                  HitActor                       (Parm, ZeroConstructor, IsPlainOldData)
// struct FHitResult              HitResult                      (Parm)

void AKingKaiju_Character_BP_C::RegisterHitForSwipeCharge(class AActor* HitActor, const struct FHitResult& HitResult)
{
...
// (NetReliable, NetRequest, Native, NetResponse, MulticastDelegate, Private, Protected, Delegate, NetServer, HasDefaults, BlueprintCallable, BlueprintPure, NetValidate)
// Parameters:
...
float AKingKaiju_Character_BP_C::BlueprintAdjustOutputDamage(int* AttackIndex, float* OriginalDamageAmount, class AActor** HitActor, class UClass** OutDamageType, float* OutDamageImpulse)
{
...
void AKingKaiju_Character_BP_C::Stun_KaijusFromCharge(class APrimalCharacter* Target, bool* StunnedKaiju)
{
...
void AKingKaiju_Character_BP_C::LaunchMeteor(const struct FTransform& Transform, bool CreateWarning, const struct FVector& WarningLoc, const struct FRotator& WarningRot)
{
