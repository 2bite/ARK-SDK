...
{
public:
	class UDinoCharacterStatusComponent_BP_LanternLizard_C* DinoCharacterStatus_BP_LanternLizard_C1;                  // 0x24C8(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
