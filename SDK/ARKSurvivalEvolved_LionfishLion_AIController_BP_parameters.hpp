...
#include "ARKSurvivalEvolved_LionfishLion_AIController_BP_classes.hpp"
...
struct ALionfishLion_AIController_BP_C_is_night_Params
{
	bool                                               ReturnValue;                                              // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function LionfishLion_AIController_BP.LionfishLion_AIController_BP_C.is line of sight blocked
struct ALionfishLion_AIController_BP_C_is_line_of_sight_blocked_Params
{
