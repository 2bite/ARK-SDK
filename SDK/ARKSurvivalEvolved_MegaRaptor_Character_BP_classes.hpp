...
public:
	...
	class UDinoCharacterStatusComponent_BP_MegaRaptor_C* DinoCharacterStatus_BP_MegaRaptor_C1;                     // 0x2450(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
