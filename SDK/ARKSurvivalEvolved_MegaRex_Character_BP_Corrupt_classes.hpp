...
public:
	...
	class UDinoCharacterStatusComponent_BP_MegaRex_Corrupted_C* DinoCharacterStatus_BP_MegaRex_Corrupted_C1;              // 0x22B8(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
