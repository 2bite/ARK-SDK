...
// (NetReliable, NetRequest, Exec, Event, NetResponse, Static, MulticastDelegate, Private, HasDefaults, BlueprintPure, Const, NetValidate)
// Parameters:
// bool                           NewParam                       (Parm, ZeroConstructor, IsPlainOldData)

void AMeteor_launcher_C::STATIC_Shoot(bool NewParam)
{
...
// (Exec, Native, Event, NetResponse, Static, MulticastDelegate, Private, HasDefaults, BlueprintPure, Const, NetValidate)

void AMeteor_launcher_C::STATIC_UserConstructionScript()
{
