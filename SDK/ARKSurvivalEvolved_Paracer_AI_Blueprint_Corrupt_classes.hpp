...
#include "ARKSurvivalEvolved_Paracer_AI_Blueprint_Corrupt_structs.hpp"
...
// BlueprintGeneratedClass Paracer_AI_Blueprint_Corrupt.Paracer_AI_Blueprint_Corrupt_C
// 0x0027 (0x0910 - 0x08E9)
class AParacer_AI_Blueprint_Corrupt_C : public AParacer_AI_Blueprint_C
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Paracer_AI_Blueprint_Corrupt.Paracer_AI_Blueprint_Corrupt_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_Paracer_AI_Blueprint_Corrupt(int EntryPoint);
};
