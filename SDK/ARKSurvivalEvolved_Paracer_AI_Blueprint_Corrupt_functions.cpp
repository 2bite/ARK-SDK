...
// Function Paracer_AI_Blueprint_Corrupt.Paracer_AI_Blueprint_Corrupt_C.BPShouldNotifyAnyNeighbor
// ()
// Parameters:
// class APrimalDinoCharacter**   neighbor                       (Parm, ZeroConstructor, IsPlainOldData)
// bool                           ReturnValue                    (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)

bool AParacer_AI_Blueprint_Corrupt_C::BPShouldNotifyAnyNeighbor(class APrimalDinoCharacter** neighbor)
{
	static auto fn = UObject::FindObject<UFunction>("Function Paracer_AI_Blueprint_Corrupt.Paracer_AI_Blueprint_Corrupt_C.BPShouldNotifyAnyNeighbor");

	AParacer_AI_Blueprint_Corrupt_C_BPShouldNotifyAnyNeighbor_Params params;
