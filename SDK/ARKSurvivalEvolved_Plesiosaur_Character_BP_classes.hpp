...
public:
	...
	class UDinoCharacterStatusComponent_BP_Plesiosaur_C* DinoCharacterStatus_BP_Plesiosaur_C1;                     // 0x2190(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
