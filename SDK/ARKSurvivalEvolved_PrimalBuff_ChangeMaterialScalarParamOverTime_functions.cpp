...
#include "ARKSurvivalEvolved_PrimalBuff_ChangeMaterialScalarParamOverTime_parameters.hpp"
...
void APrimalBuff_ChangeMaterialScalarParamOverTime_C::Set_Param_Value(class UMeshComponent* Mesh, float Value)
{
	static auto fn = UObject::FindObject<UFunction>("Function PrimalBuff_ChangeMaterialScalarParamOverTime.PrimalBuff_ChangeMaterialScalarParamOverTime_C.Set Param Value");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function PrimalBuff_ChangeMaterialScalarParamOverTime.PrimalBuff_ChangeMaterialScalarParamOverTime_C.BPSetupForInstigator");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function PrimalBuff_ChangeMaterialScalarParamOverTime.PrimalBuff_ChangeMaterialScalarParamOverTime_C.UserConstructionScript");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function PrimalBuff_ChangeMaterialScalarParamOverTime.PrimalBuff_ChangeMaterialScalarParamOverTime_C.ParamTimeline__FinishedFunc");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function PrimalBuff_ChangeMaterialScalarParamOverTime.PrimalBuff_ChangeMaterialScalarParamOverTime_C.ParamTimeline__UpdateFunc");
...
// ()
// Parameters:
// bool                           Forward_                       (Parm, ZeroConstructor, IsPlainOldData)

void APrimalBuff_ChangeMaterialScalarParamOverTime_C::StartTimeline(bool Forward_)
{
	static auto fn = UObject::FindObject<UFunction>("Function PrimalBuff_ChangeMaterialScalarParamOverTime.PrimalBuff_ChangeMaterialScalarParamOverTime_C.StartTimeline");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function PrimalBuff_ChangeMaterialScalarParamOverTime.PrimalBuff_ChangeMaterialScalarParamOverTime_C.ReceiveBeginPlay");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function PrimalBuff_ChangeMaterialScalarParamOverTime.PrimalBuff_ChangeMaterialScalarParamOverTime_C.SetValues");
...
void APrimalBuff_ChangeMaterialScalarParamOverTime_C::ExecuteUbergraph_PrimalBuff_ChangeMaterialScalarParamOverTime(int EntryPoint)
{
	static auto fn = UObject::FindObject<UFunction>("Function PrimalBuff_ChangeMaterialScalarParamOverTime.PrimalBuff_ChangeMaterialScalarParamOverTime_C.ExecuteUbergraph_PrimalBuff_ChangeMaterialScalarParamOverTime");
