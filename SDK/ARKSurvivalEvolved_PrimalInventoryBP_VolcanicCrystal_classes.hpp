...
#include "ARKSurvivalEvolved_PrimalInventoryBP_VolcanicCrystal_structs.hpp"
...
class UPrimalInventoryBP_VolcanicCrystal_C : public UPrimalInventoryComponent
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass PrimalInventoryBP_VolcanicCrystal.PrimalInventoryBP_VolcanicCrystal_C");
		return ptr;
	}


	void BPAccessedInventory(class AShooterPlayerController** ForPC);
	void ExecuteUbergraph_PrimalInventoryBP_VolcanicCrystal(int EntryPoint);
};
