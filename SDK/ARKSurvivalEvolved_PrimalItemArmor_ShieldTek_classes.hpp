...
// 0x0007 (0x09E8 - 0x09E1)
class UPrimalItemArmor_ShieldTek_C : public UPrimalItemArmor_Base_Tek_C
{
public:
	unsigned char                                      UnknownData00[0x3];                                       // 0x09E1(0x0003) MISSED OFFSET
	float                                              DurabilityCostPerReflection;                              // 0x09E4(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
