...
#include "ARKSurvivalEvolved_PrimalItemConsumable_Crafted_FourthOfJulyDinoCandy_structs.hpp"
...
// BlueprintGeneratedClass PrimalItemConsumable_Crafted_FourthOfJulyDinoCandy.PrimalItemConsumable_Crafted_FourthOfJulyDinoCandy_C
// 0x0068 (0x09F8 - 0x0990)
class UPrimalItemConsumable_Crafted_FourthOfJulyDinoCandy_C : public UPrimalItemConsumableEatable_C
{
public:
	...
	class UTexture*                                    AscendantIcon;                                            // 0x09E0(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class FString                                      CallFunc_Array_Add_NewItem_RefProperty;                   // 0x09E8(0x0010) (OutParm, ZeroConstructor, Transient, DuplicateTransient, ReferenceParm)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass PrimalItemConsumable_Crafted_FourthOfJulyDinoCandy.PrimalItemConsumable_Crafted_FourthOfJulyDinoCandy_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_PrimalItemConsumable_Crafted_FourthOfJulyDinoCandy(int EntryPoint);
};
