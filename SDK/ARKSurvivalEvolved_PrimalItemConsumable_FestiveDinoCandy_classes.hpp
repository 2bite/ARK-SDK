...
#include "ARKSurvivalEvolved_PrimalItemConsumable_FestiveDinoCandy_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass PrimalItemConsumable_FestiveDinoCandy.PrimalItemConsumable_FestiveDinoCandy_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_PrimalItemConsumable_FestiveDinoCandy(int EntryPoint);
};
