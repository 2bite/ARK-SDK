...
public:
	...
	int                                                saved_amount_of_mutagel_needed;                           // 0x0B20(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	...
	void find_strider(bool Backup, class APrimalDinoCharacter** strider);
