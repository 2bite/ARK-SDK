...
#include "ARKSurvivalEvolved_PrimalItemConsumable_ValentinesDinoCandy_structs.hpp"
...
// BlueprintGeneratedClass PrimalItemConsumable_ValentinesDinoCandy.PrimalItemConsumable_ValentinesDinoCandy_C
// 0x0060 (0x0A60 - 0x0A00)
class UPrimalItemConsumable_ValentinesDinoCandy_C : public UPrimalItemConsumableEatable_C
{
public:
	...
	class FString                                      CallFunc_Array_Add_NewItem_RefProperty;                   // 0x0A50(0x0010) (OutParm, ZeroConstructor, Transient, DuplicateTransient, ReferenceParm)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass PrimalItemConsumable_ValentinesDinoCandy.PrimalItemConsumable_ValentinesDinoCandy_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_PrimalItemConsumable_ValentinesDinoCandy(int EntryPoint);
};
