...
// (Net, NetReliable, Native, Event, Static, NetMulticast, Public, Private, HasDefaults, BlueprintPure, Const, NetValidate)

void UPrimalItem_Spawner_Enforcer_CityTerminal_C::STATIC_PreDinoSpawned()
{
