...
{
public:
	class FString                                      FoodStatLabel;                                            // 0x0BE8(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
	class FString                                      MeleeDamageStatLabel;                                     // 0x0BF8(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
