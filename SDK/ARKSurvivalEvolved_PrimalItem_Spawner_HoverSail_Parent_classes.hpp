...
// 0x0178 (0x0E68 - 0x0CF0)
class UPrimalItem_Spawner_HoverSail_Parent_C : public UPrimalItem_DinoSpawner_Base_C
{
public:
	int                                                NumSpawnAttempts;                                         // 0x0CF0(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData00[0x4];                                       // 0x0CF4(0x0004) MISSED OFFSET
	class AShooterCharacter*                           CraftingShooterChar;                                      // 0x0CF8(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, IsPlainOldData)
	...
	unsigned char                                      UnknownData02[0x7];                                       // 0x0D61(0x0007) MISSED OFFSET
	...
	unsigned char                                      UnknownData03[0x6];                                       // 0x0D9A(0x0006) MISSED OFFSET
	...
	unsigned char                                      UnknownData04[0x2];                                       // 0x0DBE(0x0002) MISSED OFFSET
	...
	unsigned char                                      UnknownData05[0x3];                                       // 0x0DC9(0x0003) MISSED OFFSET
	...
	unsigned char                                      UnknownData07[0x7];                                       // 0x0E19(0x0007) MISSED OFFSET
	...
	unsigned char                                      UnknownData08[0x3];                                       // 0x0E45(0x0003) MISSED OFFSET
	...
	unsigned char                                      UnknownData09[0x2];                                       // 0x0E56(0x0002) MISSED OFFSET
