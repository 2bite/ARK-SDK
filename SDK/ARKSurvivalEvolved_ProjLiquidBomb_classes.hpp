...
public:
	...
	class UStaticMeshComponent*                        StaticMesh2;                                              // 0x0670(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              Rotation;                                                 // 0x0678(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<EEndPlayReason>                        K2Node_Event_EndPlayReason;                               // 0x067C(0x0001) (ZeroConstructor, Transient, DuplicateTransient, IsPlainOldData)
