...
public:
	...
	class USphereComponent*                            Sphere1;                                                  // 0x0650(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               isPrimalSpore;                                            // 0x0658(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
