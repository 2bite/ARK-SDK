...
#include "ARKSurvivalEvolved_RandomWait_TK_Archa_structs.hpp"
...
class URandomWait_TK_Archa_C : public UBTTask_BlueprintBase
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass RandomWait_TK_Archa.RandomWait_TK_Archa_C");
		return ptr;
	}


	void ReceiveExecute(class AActor** OwnerActor);
	void ExecuteUbergraph_RandomWait_TK_Archa(int EntryPoint);
};
