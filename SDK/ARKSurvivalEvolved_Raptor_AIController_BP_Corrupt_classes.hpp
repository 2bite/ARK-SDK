...
#include "ARKSurvivalEvolved_Raptor_AIController_BP_Corrupt_structs.hpp"
...
// BlueprintGeneratedClass Raptor_AIController_BP_Corrupt.Raptor_AIController_BP_Corrupt_C
// 0x0027 (0x0910 - 0x08E9)
class ARaptor_AIController_BP_Corrupt_C : public ARaptor_AIController_BP_C
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Raptor_AIController_BP_Corrupt.Raptor_AIController_BP_Corrupt_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_Raptor_AIController_BP_Corrupt(int EntryPoint);
};
