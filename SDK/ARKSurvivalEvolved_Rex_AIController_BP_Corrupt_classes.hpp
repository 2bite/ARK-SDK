...
#include "ARKSurvivalEvolved_Rex_AIController_BP_Corrupt_structs.hpp"
...
// BlueprintGeneratedClass Rex_AIController_BP_Corrupt.Rex_AIController_BP_Corrupt_C
// 0x0027 (0x0910 - 0x08E9)
class ARex_AIController_BP_Corrupt_C : public ARex_AIController_BP_C
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Rex_AIController_BP_Corrupt.Rex_AIController_BP_Corrupt_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_Rex_AIController_BP_Corrupt(int EntryPoint);
};
