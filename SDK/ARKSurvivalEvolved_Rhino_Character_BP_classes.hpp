...
// 0x000C (0x2274 - 0x2268)
class ARhino_Character_BP_C : public ADino_Character_BP_C
{
public:
	class UDinoCharacterStatusComponent_BP_Rhino_C*    DinoCharacterStatus_BP_Rhino_C1;                          // 0x2268(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              MaxExtraSpeedAdditionalDamagePercent;                     // 0x2270(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
