...
public:
	...
	class UDinoCharacterStatusComponent_BP_RubbleGolem_C* DinoCharacterStatus_BP_RubbleGolem_C1;                    // 0x2278(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
