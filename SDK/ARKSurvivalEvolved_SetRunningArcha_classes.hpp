...
#include "ARKSurvivalEvolved_SetRunningArcha_structs.hpp"
...
class USetRunningArcha_C : public UBTTask_BlueprintBase
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass SetRunningArcha.SetRunningArcha_C");
		return ptr;
	}


	void ReceiveExecute(class AActor** OwnerActor);
	void ExecuteUbergraph_SetRunningArcha(int EntryPoint);
};
