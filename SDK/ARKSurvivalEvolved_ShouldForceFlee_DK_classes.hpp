...
#include "ARKSurvivalEvolved_ShouldForceFlee_DK_structs.hpp"
...
public:
	...
	bool                                               CallFunc_ShouldForceFlee_ReturnValue;                     // 0x00B9(0x0001) (ZeroConstructor, Transient, DuplicateTransient, IsPlainOldData)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass ShouldForceFlee_DK.ShouldForceFlee_DK_C");
		return ptr;
	}


	void ReceiveConditionCheck(class AActor** OwnerActor);
	void ExecuteUbergraph_ShouldForceFlee_DK(int EntryPoint);
};
