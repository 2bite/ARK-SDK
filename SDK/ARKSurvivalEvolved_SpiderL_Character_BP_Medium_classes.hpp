...
public:
	...
	class UDinoCharacterStatusComponent_BP_SpiderBoss_Medium_C* DinoCharacterStatus_BP_SpiderBoss_Medium_C1;              // 0x2170(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
