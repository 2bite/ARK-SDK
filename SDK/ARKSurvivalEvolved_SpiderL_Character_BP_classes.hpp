...
// 0x0061 (0x21E9 - 0x2188)
class ASpiderL_Character_BP_C : public ADino_Character_BP_IgnoredByWebs_C
{
public:
	class UDinoCharacterStatusComponent_BP_SpiderBoss_C* DinoCharacterStatus_BP_SpiderBoss_C1;                     // 0x2188(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	int                                                DifficultyIndex;                                          // 0x2194(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	TArray<struct FLinearColor>                        healthBarColorsByDifficulty;                              // 0x2198(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
