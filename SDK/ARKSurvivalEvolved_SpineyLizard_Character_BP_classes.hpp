...
{
public:
	class UDinoCharacterStatusComponent_BP_SpineyLizard_C* DinoCharacterStatus_BP_SpineyLizard_C1;                   // 0x2108(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
