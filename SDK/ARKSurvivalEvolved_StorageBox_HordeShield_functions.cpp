...
// (Exec, Native, Event, NetResponse, Static, Public, Private, Protected, NetServer, BlueprintCallable, NetValidate)
// Parameters:
...
// (NetRequest, Exec, Static, NetMulticast, Public, Private, Protected, NetServer, BlueprintCallable, NetValidate)
// Parameters:
...
void AStorageBox_HordeShield_C::STATIC_BPHitEffect(float* DamageTaken, class APawn** PawnInstigator, class AActor** DamageCauser, bool* bIsLocalPath, class UPrimitiveComponent** HitComponent, struct FVector* DamageLoc, struct FRotator* HitNormal, struct FDamageEvent* DamageEvent)
{
...
// (NetRequest, Native, NetMulticast, MulticastDelegate, Private, Protected, Delegate, HasDefaults, DLLImport)
// Parameters:
// class APlayerController**      ForPC                          (Parm, ZeroConstructor, IsPlainOldData)
