...
{
public:
	class UClass*                                      TeleporterBaseClass;                                      // 0x0AB8(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class AActor*                                      SpawnTeleporterPoint;                                     // 0x0AC0(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, IsPlainOldData)
	class ADungeonArenaManager_C*                      TheDungeonManager;                                        // 0x0AC8(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, IsPlainOldData)
	TArray<class UClass*>                              TeleporterDifficultyClasses;                              // 0x0AD0(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
