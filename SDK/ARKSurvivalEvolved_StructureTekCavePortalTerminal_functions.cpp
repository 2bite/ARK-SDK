...
// (NetRequest, Exec, Event, Static, MulticastDelegate, Public, Private, Protected, DLLImport, BlueprintCallable, Const)
// Parameters:
...
// (NetReliable, NetResponse, Static, MulticastDelegate, Public, Private, Protected, DLLImport, BlueprintCallable, Const)
// Parameters:
// class APlayerController**      ForPC                          (Parm, ZeroConstructor, IsPlainOldData)
