...
{
public:
	class UPrimalInventoryBP_Catapult_C*               PrimalInventoryBP_Catapult_C1;                            // 0x1038(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class USkeletalMeshComponent*                      CatapultMesh;                                             // 0x1040(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
