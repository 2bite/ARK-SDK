...
{
public:
	class UPrimalInventoryBP_TurretTek_C*              PrimalInventoryBP_TurretTek_C1;                           // 0x0ED8(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	TArray<class UClass*>                              DinoClassList;                                            // 0x0EF8(0x0010) (Edit, BlueprintVisible, Net, ZeroConstructor, DisableEditOnInstance, SaveGame)
	int                                                MaxDinoClasses;                                           // 0x0F08(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               bIsInclusionList;                                         // 0x0F0C(0x0001) (Edit, BlueprintVisible, Net, ZeroConstructor, DisableEditOnInstance, SaveGame, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0F0D(0x0003) MISSED OFFSET
	TArray<class UClass*>                              LastLocalInRangeClasses;                                  // 0x0F10(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
	int                                                MinDinoLevel;                                             // 0x0F20(0x0004) (Edit, BlueprintVisible, Net, ZeroConstructor, DisableEditOnInstance, SaveGame, IsPlainOldData)
	int                                                MaxDinoLevel;                                             // 0x0F24(0x0004) (Edit, BlueprintVisible, Net, ZeroConstructor, DisableEditOnInstance, SaveGame, IsPlainOldData)
	bool                                               bTooManyInRangeInactive;                                  // 0x0F28(0x0001) (Edit, BlueprintVisible, Net, ZeroConstructor, Transient, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData01[0x7];                                       // 0x0F29(0x0007) MISSED OFFSET
	TArray<class AActor*>                              CallFunc_SphereOverlapActorsSimple_ActorsToIgnore_RefProperty;// 0x0F30(0x0010) (OutParm, ZeroConstructor, Transient, DuplicateTransient, ReferenceParm)
