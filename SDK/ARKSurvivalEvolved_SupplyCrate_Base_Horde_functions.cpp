...
// (NetReliable, NetRequest, Exec, Native, NetResponse, NetMulticast, Public, Private, Protected, HasDefaults, NetClient, BlueprintCallable, BlueprintPure, Const, NetValidate)
// Parameters:
...
// (NetRequest, Exec, Native, NetResponse, Public, Private, Protected, HasDefaults, NetClient, BlueprintCallable, BlueprintPure, Const, NetValidate)
// Parameters:
// class APlayerController**      ForPC                          (Parm, ZeroConstructor, IsPlainOldData)
// TArray<struct FMultiUseEntry>  MultiUseEntries                (Parm, OutParm, ZeroConstructor, ReferenceParm)
// TArray<struct FMultiUseEntry>  ReturnValue                    (Parm, OutParm, ZeroConstructor, ReturnParm)

TArray<struct FMultiUseEntry> ASupplyCrate_Base_Horde_C::BPGetMultiUseEntries(class APlayerController** ForPC, TArray<struct FMultiUseEntry>* MultiUseEntries)
{
...
// (NetReliable, Exec, Event, NetResponse, Public, Private, NetServer, HasDefaults, NetClient, Const, NetValidate)

void ASupplyCrate_Base_Horde_C::CrateCleanup()
{
...
// (NetReliable, Exec, Native, Event, Static, NetMulticast, Public, Private, NetServer, HasDefaults, NetClient, Const, NetValidate)

void ASupplyCrate_Base_Horde_C::STATIC_ConfigureWaves()
{
