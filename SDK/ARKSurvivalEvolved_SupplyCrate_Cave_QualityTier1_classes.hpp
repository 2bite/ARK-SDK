...
#include "ARKSurvivalEvolved_SupplyCrate_Cave_QualityTier1_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass SupplyCrate_Cave_QualityTier1.SupplyCrate_Cave_QualityTier1_C");
		return ptr;
	}


	void UserConstructionScript();
	void ExecuteUbergraph_SupplyCrate_Cave_QualityTier1(int EntryPoint);
};
