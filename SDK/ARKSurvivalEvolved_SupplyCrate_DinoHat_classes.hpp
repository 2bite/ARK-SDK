...
#include "ARKSurvivalEvolved_SupplyCrate_DinoHat_structs.hpp"
...
// BlueprintGeneratedClass SupplyCrate_DinoHat.SupplyCrate_DinoHat_C
// 0x0027 (0x1020 - 0x0FF9)
class ASupplyCrate_DinoHat_C : public ASupplyCrateBaseBP_C
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass SupplyCrate_DinoHat.SupplyCrate_DinoHat_C");
		return ptr;
	}


	void UserConstructionScript();
	void ExecuteUbergraph_SupplyCrate_DinoHat(int EntryPoint);
};
