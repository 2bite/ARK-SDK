...
// (NetRequest, Event, NetResponse, NetMulticast, Private, Delegate, NetServer, HasDefaults, BlueprintCallable, BlueprintPure, Const)
...
// (NetReliable, Exec, Native, Event, Static, NetMulticast, Private, Delegate, NetServer, HasDefaults, BlueprintCallable, BlueprintPure, Const)
// Parameters:
...
bool ASupplyCrate_Horde_MeteorBase_C::STATIC_BPImpactEffect(struct FHitResult* HitRes, struct FVector* ShootDirection)
{
