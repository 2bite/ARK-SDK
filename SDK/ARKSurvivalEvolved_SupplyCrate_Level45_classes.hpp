...
#include "ARKSurvivalEvolved_SupplyCrate_Level45_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass SupplyCrate_Level45.SupplyCrate_Level45_C");
		return ptr;
	}


	void UserConstructionScript();
	void ExecuteUbergraph_SupplyCrate_Level45(int EntryPoint);
};
