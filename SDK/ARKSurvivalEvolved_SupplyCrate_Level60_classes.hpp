...
#include "ARKSurvivalEvolved_SupplyCrate_Level60_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass SupplyCrate_Level60.SupplyCrate_Level60_C");
		return ptr;
	}


	void UserConstructionScript();
	void ExecuteUbergraph_SupplyCrate_Level60(int EntryPoint);
};
