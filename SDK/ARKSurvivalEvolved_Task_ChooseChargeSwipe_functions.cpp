...
// (NetResponse, Static, MulticastDelegate, Public, Protected, NetServer, HasDefaults, NetClient, DLLImport, BlueprintCallable, BlueprintEvent, BlueprintPure, Const)
// Parameters:
// class AActor**                 OwnerActor                     (Parm, ZeroConstructor, IsPlainOldData)

void UTask_ChooseChargeSwipe_C::STATIC_ReceiveExecute(class AActor** OwnerActor)
{
