...
#include "ARKSurvivalEvolved_Task_IceKaijuIntro_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Task_IceKaijuIntro.Task_IceKaijuIntro_C");
		return ptr;
	}


	void ReceiveExecute(class AActor** OwnerActor);
	void ExecuteUbergraph_Task_IceKaijuIntro(int EntryPoint);
};
