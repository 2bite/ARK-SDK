...
#include "ARKSurvivalEvolved_Tek_Shield_RIG_AnimBlueprint_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("AnimBlueprintGeneratedClass Tek_Shield_RIG_AnimBlueprint.Tek_Shield_RIG_AnimBlueprint_C");
		return ptr;
	}


	void EvaluateGraphExposedInputs_ExecuteUbergraph_Tek_Shield_RIG_AnimBlueprint_AnimGraphNode_BlendListByBool_2156();
	void BlueprintUpdateAnimation(float* DeltaTimeX);
	void ExecuteUbergraph_Tek_Shield_RIG_AnimBlueprint(int EntryPoint);
};
