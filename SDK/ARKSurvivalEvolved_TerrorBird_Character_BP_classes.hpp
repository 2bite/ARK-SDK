...
{
public:
	class UDinoCharacterStatusComponent_BP_TerrorBird_C* DinoCharacterStatus_BP_TerrorBird_C1;                     // 0x2108(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
