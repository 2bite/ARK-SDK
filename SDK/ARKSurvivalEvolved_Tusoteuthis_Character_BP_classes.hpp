...
public:
	...
	float                                              TurnActorAround_TurnRatio_7A27B9E24FC0E1B141AC4AB1071050C9;// 0x21A8(0x0004) (ZeroConstructor, IsPlainOldData)
	TEnumAsByte<ETimelineDirection>                    TurnActorAround__Direction_7A27B9E24FC0E1B141AC4AB1071050C9;// 0x21AC(0x0001) (ZeroConstructor, IsPlainOldData)
	...
	float                                              TurnMeshAround_TurnRatio_DF7773704E3A5A03D67822BDB05E3DB4;// 0x21B8(0x0004) (ZeroConstructor, IsPlainOldData)
	TEnumAsByte<ETimelineDirection>                    TurnMeshAround__Direction_DF7773704E3A5A03D67822BDB05E3DB4;// 0x21BC(0x0001) (ZeroConstructor, IsPlainOldData)
	...
	class UAnimMontage*                                Ref_CrushingPreyEatMontage;                               // 0x22C0(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               Temp_bool_True_if_break_was_hit_Variable;                 // 0x22C8(0x0001) (ZeroConstructor, Transient, DuplicateTransient, IsPlainOldData)
	bool                                               CallFunc_Not_PreBool_ReturnValue;                         // 0x22C9(0x0001) (ZeroConstructor, Transient, DuplicateTransient, IsPlainOldData)
	unsigned char                                      UnknownData09[0x2];                                       // 0x22CA(0x0002) MISSED OFFSET
	struct FRotator                                    CallFunc_MakeRot_ReturnValue;                             // 0x22CC(0x000C) (ZeroConstructor, Transient, DuplicateTransient, IsPlainOldData)
	bool                                               CallFunc_IsServer_ReturnValue;                            // 0x22D8(0x0001) (ZeroConstructor, Transient, DuplicateTransient, IsPlainOldData)
	bool                                               CallFunc_CanAttack_ReturnValue;                           // 0x22D9(0x0001) (ZeroConstructor, Transient, DuplicateTransient, IsPlainOldData)
	bool                                               CallFunc_DoAttack_ReturnValue;                            // 0x22DA(0x0001) (ZeroConstructor, Transient, DuplicateTransient, IsPlainOldData)
	bool                                               K2Node_SwitchInteger_CmpSuccess;                          // 0x22DB(0x0001) (ZeroConstructor, Transient, DuplicateTransient, IsPlainOldData)
	...
	unsigned char                                      UnknownData10[0x2];                                       // 0x22DE(0x0002) MISSED OFFSET
	struct FVector                                     CallFunc_GetSocketLocation_ReturnValue;                   // 0x22E0(0x000C) (ZeroConstructor, Transient, DuplicateTransient, IsPlainOldData)
	unsigned char                                      UnknownData11[0x4];                                       // 0x22EC(0x0004) MISSED OFFSET
	...
	unsigned char                                      UnknownData19[0x2];                                       // 0x2646(0x0002) MISSED OFFSET
	...
	bool                                               CallFunc_BooleanAND_ReturnValue5;                         // 0x2658(0x0001) (ZeroConstructor, Transient, DuplicateTransient, IsPlainOldData)
	...
	bool                                               CallFunc_BooleanAND_ReturnValue6;                         // 0x267A(0x0001) (ZeroConstructor, Transient, DuplicateTransient, IsPlainOldData)
	...
	bool                                               CallFunc_BooleanAND_ReturnValue7;                         // 0x26B9(0x0001) (ZeroConstructor, Transient, DuplicateTransient, IsPlainOldData)
	unsigned char                                      UnknownData25[0x6];                                       // 0x26BA(0x0006) MISSED OFFSET
	class ATusoteuthis_Character_BP_C*                 CallFunc_GetDefaultDino_Ref;                              // 0x26C0(0x0008) (ZeroConstructor, Transient, DuplicateTransient, IsPlainOldData)
	...
	void InpActEvt_Jump_K2Node_InputActionEvent_214();
