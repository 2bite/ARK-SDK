...
#include "ARKSurvivalEvolved_UseTamedNoTargetBehavior_structs.hpp"
...
public:
	...
	bool                                               CallFunc_NotEqual_ObjectObject_ReturnValue;               // 0x00B9(0x0001) (ZeroConstructor, Transient, DuplicateTransient, IsPlainOldData)
	bool                                               CallFunc_GreaterEqual_IntInt_ReturnValue;                 // 0x00BA(0x0001) (ZeroConstructor, Transient, DuplicateTransient, IsPlainOldData)
	bool                                               CallFunc_BooleanAND_ReturnValue;                          // 0x00BB(0x0001) (ZeroConstructor, Transient, DuplicateTransient, IsPlainOldData)
