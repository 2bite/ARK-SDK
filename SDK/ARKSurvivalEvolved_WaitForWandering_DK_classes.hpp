...
#include "ARKSurvivalEvolved_WaitForWandering_DK_structs.hpp"
...
public:
	...
	bool                                               CallFunc_EqualEqual_ObjectObject_ReturnValue;             // 0x00B9(0x0001) (ZeroConstructor, Transient, DuplicateTransient, IsPlainOldData)
