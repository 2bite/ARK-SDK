...
{
public:
	class UStaticMeshComponent*                        StaticMesh1;                                              // 0x0E68(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class USceneComponent*                             CableStart3P;                                             // 0x0E70(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
