...
public:
	...
	class UStaticMeshComponent*                        FlashlightAttachment1p;                                   // 0x0DE8(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UParticleSystemComponent*                    SecondaryTPVToggleComponent;                              // 0x0DF0(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class USpotLightComponent*                         TPVToggleComponent;                                       // 0x0DF8(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UStaticMeshComponent*                        FlashlightAttachment3p;                                   // 0x0E00(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
