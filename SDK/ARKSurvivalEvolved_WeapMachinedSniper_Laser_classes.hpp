...
public:
	...
	class UStaticMeshComponent*                        _1pAttachmentLaser;                                       // 0x0DA0(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UShooterLaserBeamComponent*                  TPVLaserBeam;                                             // 0x0DA8(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UStaticMeshComponent*                        _3pAttachmentLaser;                                       // 0x0DB0(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
