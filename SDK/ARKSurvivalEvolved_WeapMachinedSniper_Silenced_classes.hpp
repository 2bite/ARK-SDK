...
{
public:
	class UStaticMeshComponent*                        _1pAttachmentSilencer;                                    // 0x0DD8(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UStaticMeshComponent*                        _3pAttachementSilencer;                                   // 0x0DE0(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
