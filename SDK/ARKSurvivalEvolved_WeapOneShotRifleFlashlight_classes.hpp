...
{
public:
	class UParticleSystemComponent*                    SecondaryTPVToggleComponent;                              // 0x0D88(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class USpotLightComponent*                         TPVToggleComponent;                                       // 0x0D90(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	class UStaticMeshComponent*                        FirstPersonAttachment;                                    // 0x0DB0(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
