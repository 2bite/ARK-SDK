...
{
public:
	class UStaticMeshComponent*                        FPVComponent;                                             // 0x0D58(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UStaticMeshComponent*                        TPVComponent;                                             // 0x0D60(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
