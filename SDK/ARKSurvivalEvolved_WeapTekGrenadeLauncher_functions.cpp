...
// (Net, NetReliable, NetRequest, Native, Event, NetMulticast, Public, Private, Protected, Delegate, HasOutParms, HasDefaults, NetClient, DLLImport, BlueprintEvent, Const, NetValidate)
// Parameters:
// int                            CurrentSlot                    (Parm, OutParm, ZeroConstructor, IsPlainOldData)
// float                          Remainder                      (Parm, OutParm, ZeroConstructor, IsPlainOldData)

void AWeapTekGrenadeLauncher_C::GetCurrentSlotAdvancement(int* CurrentSlot, float* Remainder)
{
...
// (Event, Static, NetMulticast, MulticastDelegate, Public, Private, NetServer, HasOutParms, HasDefaults, NetClient, DLLImport, BlueprintEvent, Const, NetValidate)
// Parameters:
// bool                           bCanReload                     (Parm, OutParm, ZeroConstructor, IsPlainOldData)

void AWeapTekGrenadeLauncher_C::STATIC_CanReloadLauncher(bool* bCanReload)
{
...
// (NetRequest, NetResponse, Static, NetMulticast, MulticastDelegate, Public, Private, NetServer, HasOutParms, HasDefaults, NetClient, DLLImport, BlueprintEvent, Const, NetValidate)
...
// (MulticastDelegate, Public, Private, NetServer, HasOutParms, HasDefaults, NetClient, DLLImport, BlueprintEvent, Const, NetValidate)
// Parameters:
...
// (NetReliable, NetRequest, Exec, Native, Static, NetMulticast, Public, Private, Protected, Delegate, HasOutParms, HasDefaults, NetClient, DLLImport, BlueprintEvent, Const, NetValidate)
...
// (NetRequest, Event, Static, MulticastDelegate, Public, Private, NetServer, HasOutParms, HasDefaults, NetClient, DLLImport, BlueprintEvent, Const, NetValidate)

void AWeapTekGrenadeLauncher_C::STATIC_SyncAmmoInClipValue()
{
...
// (NetRequest, Native, Event, Static, MulticastDelegate, Public, Private, NetServer, HasOutParms, HasDefaults, NetClient, DLLImport, BlueprintEvent, Const, NetValidate)
// Parameters:
...
// (NetReliable, NetRequest, Exec, Native, Event, Static, MulticastDelegate, Public, Private, NetServer, HasOutParms, HasDefaults, NetClient, DLLImport, BlueprintEvent, Const, NetValidate)
...
// (NetRequest, Event, NetResponse, Static, MulticastDelegate, Public, Private, NetServer, HasOutParms, HasDefaults, NetClient, DLLImport, BlueprintEvent, Const, NetValidate)
// Parameters:
// bool                           Success                        (Parm, OutParm, ZeroConstructor, IsPlainOldData)

void AWeapTekGrenadeLauncher_C::STATIC_LoadAmmoFromItem(bool* Success)
{
...
// (NetReliable, NetRequest, NetMulticast, MulticastDelegate, Public, Private, NetServer, HasOutParms, HasDefaults, NetClient, DLLImport, BlueprintEvent, Const, NetValidate)
// Parameters:
// int                            SlotIdx                        (Parm, ZeroConstructor, IsPlainOldData)
// class UClass*                  ItemType                       (Parm, ZeroConstructor, IsPlainOldData)
// bool                           Success                        (Parm, OutParm, ZeroConstructor, IsPlainOldData)

void AWeapTekGrenadeLauncher_C::SetProjectileSlotType(int SlotIdx, class UClass* ItemType, bool* Success)
{
...
// (NetRequest, Native, NetResponse, NetMulticast, MulticastDelegate, Public, Private, NetServer, HasOutParms, HasDefaults, NetClient, DLLImport, BlueprintEvent, Const, NetValidate)
...
// (NetReliable, Exec, Native, Event, NetResponse, NetMulticast, MulticastDelegate, Public, Private, NetServer, HasOutParms, HasDefaults, NetClient, DLLImport, BlueprintEvent, Const, NetValidate)
// Parameters:
...
// (NetReliable, NetRequest, Static, NetMulticast, MulticastDelegate, Public, Private, NetServer, HasOutParms, HasDefaults, NetClient, DLLImport, BlueprintEvent, Const, NetValidate)
// Parameters:
// bool                           ReturnValue                    (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)

bool AWeapTekGrenadeLauncher_C::STATIC_BPWeaponCanFire()
{
...
// (NetReliable, NetRequest, Exec, Static, NetMulticast, MulticastDelegate, Public, Private, NetServer, HasOutParms, HasDefaults, NetClient, DLLImport, BlueprintEvent, Const, NetValidate)
// Parameters:
// int                            NumReloadedSlots               (Parm, OutParm, ZeroConstructor, IsPlainOldData)

void AWeapTekGrenadeLauncher_C::STATIC_ReloadProjectiles(int* NumReloadedSlots)
{
...
// (Exec, Event, Static, NetMulticast, MulticastDelegate, Public, Private, NetServer, HasOutParms, HasDefaults, NetClient, DLLImport, BlueprintEvent, Const, NetValidate)
// Parameters:
...
void AWeapTekGrenadeLauncher_C::STATIC_BPSelectProjectileToFire(class UClass** ProjectileClassOverride, class USoundCue** FireSoundOverride, bool* bSpawnOnClient, float* OverrideMaxSpeed)
{
