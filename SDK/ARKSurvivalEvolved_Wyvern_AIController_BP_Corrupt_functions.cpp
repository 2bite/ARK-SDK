...
bool AWyvern_AIController_BP_Corrupt_C::BPShouldNotifyAnyNeighbor(class APrimalDinoCharacter** neighbor)
{
	static auto fn = UObject::FindObject<UFunction>("Function Wyvern_AIController_BP_Corrupt.Wyvern_AIController_BP_Corrupt_C.BPShouldNotifyAnyNeighbor");

	AWyvern_AIController_BP_Corrupt_C_BPShouldNotifyAnyNeighbor_Params params;
