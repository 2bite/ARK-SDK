...
// 0x000E (0x228C - 0x227E)
class AWyvern_Character_BP_ZombieLightning_C : public AWyvern_Character_BP_ZombieBase_C
{
public:
	unsigned char                                      UnknownData00[0x2];                                       // 0x227E(0x0002) MISSED OFFSET
	struct FVector                                     TargetAimOffset;                                          // 0x2280(0x000C) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
