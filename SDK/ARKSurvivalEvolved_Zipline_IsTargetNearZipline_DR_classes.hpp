...
#include "ARKSurvivalEvolved_Zipline_IsTargetNearZipline_DR_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Zipline_IsTargetNearZipline_DR.Zipline_IsTargetNearZipline_DR_C");
		return ptr;
	}


	void ReceiveConditionCheck(class AActor** OwnerActor);
	void ExecuteUbergraph_Zipline_IsTargetNearZipline_DR(int EntryPoint);
};
