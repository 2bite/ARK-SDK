...
#include "ARKSurvivalEvolved_Zipline_ShouldUseZipline_DR_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Zipline_ShouldUseZipline_DR.Zipline_ShouldUseZipline_DR_C");
		return ptr;
	}


	void ReceiveConditionCheck(class AActor** OwnerActor);
	void ExecuteUbergraph_Zipline_ShouldUseZipline_DR(int EntryPoint);
};
